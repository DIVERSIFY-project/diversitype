package unit_test.ProjAForInitUtils.src.test.java.fr.inria.diversify;

import fr.inria.diversify.ClassUseB;
import fr.inria.diversify.InterfaceB;
import fr.inria.diversify.InterfaceC;
